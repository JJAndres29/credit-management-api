...
export type { QuickCreateProductData, QuickCreateAttributeSpec, QuickCreateWithVariantsData, QuickCreateVariantSpec, AssetCreateData, AssetReuseForVariantData } from './product.datasource';
